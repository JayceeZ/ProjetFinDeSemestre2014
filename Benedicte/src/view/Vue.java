...
public class Vue {
	...
	private void menuConnection() {
		...
		switch (controller.connect(identifiantUtilisateur,
	...
	/**
	 * La methode menuRegistrationEnseignant permet a un utilisateur de
	 * s'enregistrer et d'etre ajoute a la liste d'utilisateurs en tant
	 * qu'emprunteur enseignant.
	 */
	private void menuRegistrationEnseignant() {
		...
		if (controller.ajouterEnseignant(identifiantUtilisateur,
				motDePasseUtilisateur)) {
			menuEmprunteur();
		} else {
			menuRegistration();
	...
	/**
	 * La methode menuRegistrationEtudiant permet a un utilisateur de
	 * s'enregistrer et d'etre ajoute a la liste d'utilisateurs en tant
	 * qu'emprunteur etudiant.
	 */
	private void menuRegistrationEtudiant() {
		...
		if (controller.ajouterEtudiant(identifiantUtilisateur,
				motDePasseUtilisateur)) {
			menuEmprunteur();
		} else {
			menuRegistration();
