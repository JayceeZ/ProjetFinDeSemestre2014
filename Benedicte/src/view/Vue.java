...
public class Vue {
	...
	private ArrayList<String> menuSelector(String what, Enum[] choix) {
		...
		System.out.println("Ne mettez pas d'espaces, et sï¿½parez les choix par une virgule");
	...
	private void registration(String typeUtilisateur) {
		...
		switch (controller.ajouterEmprunteur(typeUtilisateur,
				...
				case 3:
					...
					break;
				case 4:
					System.err.println("Pas assez de matiï¿½res");
					menuRegistration();
					break;
				default:
	...
	/**
	 * Cette mÃ©thode permet au gestionnaire de rÃ©parer un certain nombre d'appareil .
	 */
	...
	/**
	 * Cette mÃ©thode permet au gestionnaire de rÃ©cupÃ©rer des informations sur les objets 
	 * prÃ©sents dans le stock actuel. Il peut lister les objet selon le type, l os et l etat .
	 */
	public void information() {
		...
		.println("Que voulez-vous faire ? " +
				"\n 0. Retour " +
				"\n 1. Afficher la totalitÃ© du stock actuel " +
		...
		case 1:
			...
			// TODO Le reste
		case 2:
			System.out.println("On peut filtrer par ï¿½tat, type, os.");
			System.out.print("Choisissez un ï¿½tat parmi : ");
