...
public class StockProjectController {
	...
	public int affichageFiltreAppareil(ArrayList<String> filtre){
		...
		// Permet de voir si la personne a rentrÈ les 3 mots clÈs pour le filtre.
		if(filtre.size() != 3)
			return 2;
		...
		// Boucle sur les Ètats et met passageEtat a true si l'Ètat entrÈ en premiËre info
		// dans filtre correspond ‡ un Ètat de la classe Etat ou ‡ null.
