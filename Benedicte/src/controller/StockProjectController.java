...
public class StockProjectController {
	...
	public int affichageFiltreAppareil(ArrayList<String> filtre){
		...
		// Permet de voir si la personne a rentr� les 3 mots cl�s pour le filtre.
		if(filtre.size() != 3)
			return 2;
		...
		// Boucle sur les �tats et met passageEtat a true si l'�tat entr� en premi�re info
		// dans filtre correspond � un �tat de la classe Etat ou � null.
		...
		// M�me principe pour cette boucle mais sur les types.
